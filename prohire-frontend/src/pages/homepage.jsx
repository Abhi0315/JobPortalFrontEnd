...
// import "../App.css";
import "../pages/homepage.css"; // Assuming you have a CSS file for homepage styles
...
const Homepage = () => {
  ...
  useEffect(() => {
    fetch("https://prohires.strangled.net/headerfooter/header-footer") // Django API endpoint
      .then((res) => res.json())
      .then((data) => {
        setMenus(data.menus || []);
